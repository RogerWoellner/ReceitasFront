...
function Linhas() {
  ...
  //Caixa de seleção de PREPAROS
  // function getSelectPreparo() {
  //   const vetPreparos = [];
  //   const preparosAnteriores = [];
  //   for (let i = 0; i < preparos.length; i++) {
  //     const preparo = preparos[i];
  //     if (linha.preparo.includes(preparo._id)) {
  //       preparosAnteriores[i] = {
  //         value: preparo._id,
  //         label: preparo.descricao,
  //       };
  //     }
  //     vetPreparos[i] = {
  //       value: preparo._id,
  ...
  //       isMulti
  //       isClearable={false}
  //       value={preparosSelecionadas}
  //       defaultValue={preparosAnteriores}
  //       onChange={onChangeSelectPreparos}
  //       options={vetPreparos}
  //       styles={selectStyles}
  //     />
  //   );
  ...
  // function onChangeSelectPreparos(valores) {
  //   setPreparosSelecionadas(valores);
  //   const preparosIds = [];
  //   for (let i = 0; i < valores.length; i++) {
  //     preparosIds[i] = valores[i].value;
  //   }
  //   alterarLinha("preparos", preparosIds, linha._id);
  // }
